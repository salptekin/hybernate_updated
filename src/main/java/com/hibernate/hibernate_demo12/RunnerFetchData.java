package com.hibernate.hibernate_demo12;
...
public class RunnerFetchData {
	...
	*/
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 Hibernate: 
			    ...
			    where
			        students0_.id=?
		*/
	    Students12 st1 = session.get(Students12.class, 1001);
		...
		*/
	    Students12 st2 = session.load(Students12.class, 1002);
	     ...
	     */
	    Students12 st3 = session.get(Students12.class, 1003);
