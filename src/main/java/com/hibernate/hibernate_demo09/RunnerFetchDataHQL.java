...
public class RunnerFetchDataHQL {
	...
	public static void main(String[] args) {
		...
		//In HQL "from students" is same with "select * from students" in SQL
		//The syntax which you typed inside the createQuery() is case sensitive
		
		//1)To get all data from Students09 table by HQL
//		List<Students09> students = session.createQuery("from Students09").list();
//		for(Students09 w:students) {
//			System.out.println(w);
//		}
		
		//2)To get students whose grades are more than 50 from the Students09 table by HQL
//		List<Students09> students = session.createQuery("from Students09 where mathGrade>50").list();
//		for(Students09 w:students) {
//			System.out.println(w);
//		}
		
		//3)To get a student whose id is 11 from the Students09 table by HQL
//		Students09 students = (Students09) session.createQuery("from Students09 where id=11").uniqueResult();
...
//		Object[] students = (Object[]) session.createQuery("select name, mathGrade from Students09 where id=11").uniqueResult();
