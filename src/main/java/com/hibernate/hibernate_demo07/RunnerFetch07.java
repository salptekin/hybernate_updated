...
public class RunnerFetch07 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 because of that First-Level Cache enables and database hit once. Because Hibernate gets the data from Cache
		...
		*/
		...
		/*
		 In the session1, I got the data about the books whose id is 101 and the data is stored in first level cache but 
		 when I ask the same data by using another session which is session2 Hibernate hit the database to get the data about 
		 the books whose id is 101.
		 Actually, the data exists in the first level cache because I did not close the session but I did not configure 
		 the second level cache because of that, Hibernate could not get the data and hit the database 
		...
		*/
		...
		System.out.println(books);		
		books = session2.get(Books07.class, 102);
		System.out.println(books);
